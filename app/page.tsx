        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="group relative overflow-hidden bg-zinc-900/50 border border-zinc-800 p-4 hover:border-red-900 transition-all">
            <div className="relative h-80 w-full mb-6">
              <Image 
                src="/images/hemi-tshirt.jpg" 
                alt="Winning T-shirt Design" 
                fill 
                className="object-contain"
              />
            </div>
            <h3 className="text-2xl font-bold mb-2 uppercase tracking-wide">Hemi T-Shirt Winner</h3>
            <p className="text-zinc-400 mb-4 font-light">Award-winning design for the Hemi Network community contest.</p>
          </div>
          ...
          <div className="group relative overflow-hidden bg-zinc-900/50 border border-zinc-800 p-4 hover:border-red-900 transition-all">
            ...
            <p className="text-zinc-400 mb-4 font-light">Custom logo and branding elements for blockchain projects.</p>
          </div>
        </div>
      </section>
